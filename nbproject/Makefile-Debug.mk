...
${OBJECTDIR}/gdrive/DownloadBuffer.o: gdrive/DownloadBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/gdrive
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DFUSE_USE_VERSION=26 -D_FILE_OFFSET_BITS=64 -D_XOPEN_SOURCE=700 -I/usr/include/ `pkg-config --cflags fuse` `pkg-config --cflags libcurl` `pkg-config --cflags json-c` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdrive/DownloadBuffer.o gdrive/DownloadBuffer.cpp

${OBJECTDIR}/gdrive/FileContents.o: gdrive/FileContents.cpp 
	${MKDIR} -p ${OBJECTDIR}/gdrive
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DFUSE_USE_VERSION=26 -D_FILE_OFFSET_BITS=64 -D_XOPEN_SOURCE=700 -I/usr/include/ `pkg-config --cflags fuse` `pkg-config --cflags libcurl` `pkg-config --cflags json-c` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdrive/FileContents.o gdrive/FileContents.cpp

${OBJECTDIR}/gdrive/FileIdCacheNode.o: gdrive/FileIdCacheNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/gdrive
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DFUSE_USE_VERSION=26 -D_FILE_OFFSET_BITS=64 -D_XOPEN_SOURCE=700 -I/usr/include/ `pkg-config --cflags fuse` `pkg-config --cflags libcurl` `pkg-config --cflags json-c` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdrive/FileIdCacheNode.o gdrive/FileIdCacheNode.cpp
...
${OBJECTDIR}/gdrive/HttpQuery.o: gdrive/HttpQuery.cpp 
	${MKDIR} -p ${OBJECTDIR}/gdrive
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DFUSE_USE_VERSION=26 -D_FILE_OFFSET_BITS=64 -D_XOPEN_SOURCE=700 -I/usr/include/ `pkg-config --cflags fuse` `pkg-config --cflags libcurl` `pkg-config --cflags json-c` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdrive/HttpQuery.o gdrive/HttpQuery.cpp

${OBJECTDIR}/gdrive/HttpTransfer.o: gdrive/HttpTransfer.cpp 
	${MKDIR} -p ${OBJECTDIR}/gdrive
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DFUSE_USE_VERSION=26 -D_FILE_OFFSET_BITS=64 -D_XOPEN_SOURCE=700 -I/usr/include/ `pkg-config --cflags fuse` `pkg-config --cflags libcurl` `pkg-config --cflags json-c` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdrive/HttpTransfer.o gdrive/HttpTransfer.cpp
...
${OBJECTDIR}/gdrive/Sysinfo.o: gdrive/Sysinfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/gdrive
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DFUSE_USE_VERSION=26 -D_FILE_OFFSET_BITS=64 -D_XOPEN_SOURCE=700 -I/usr/include/ `pkg-config --cflags fuse` `pkg-config --cflags libcurl` `pkg-config --cflags json-c` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gdrive/Sysinfo.o gdrive/Sysinfo.cpp
